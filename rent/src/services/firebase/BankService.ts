...
export const getRequestById = async (id: string) => {
    const reqRef = getExpenseRequestDoc(id) as any
    const docSnap = (await getDoc(reqRef)) as any
...
export const getOtherImages = async (id: string) => {
    const picturesRef =
        otherBankPicturesDoc as CollectionReference<ContractSignedImage>
