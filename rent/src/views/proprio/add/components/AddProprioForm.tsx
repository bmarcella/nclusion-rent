...
function AddProprioForm({ done }: Props) {
    ...
    return (
        <>
            <Steps current={step}>
                <Steps.Item
                    title={'Ajouter ' + (!done ? 'entité' : 'proprietaire')}
                />
            </Steps>
            ...
            <div className="flex w-full justify-center ">
                <div className="bg-gray-50 dark:bg-gray-700 rounded-sm p-6 shadow">
                        ...
                        <>
                            <Form onSubmit={handleSubmit(onSubmit)}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {!done && typeOptions.length > 0 && (
                                        <FormItem
                                            label={t('roles.label')}
                                            invalid={!!errors.type_person}
                                            errorMessage={
                                                errors.type_person?.message
                                            }
                                        >
                                            <Controller
                                                name="type_person"
                                    ...
                                    <FormItem
                                        label="Phone (Backup)"
                                        invalid={!!errors.phone_b}
                                        errorMessage={errors.phone_b?.message}
                                    >
                                        <Controller
                                            name="phone_b"
                                            control={control}
                    ...
                    {step === 2 && (
                        <div className="text-gray-700 dark:text-white">
                            <EndBank
                                message={t('entity.submitSuccess')}
                                btnText="Nouvelle entité"
                                onRestart={(): void => {
                                    setStep(0)
                                    setDocRef(null)
                                    reset()
