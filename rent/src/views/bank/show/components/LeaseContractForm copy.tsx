...
const LeaseContractForm = ({ bank, isPrint }: Props) => {
            ...
            {landlord && (
                <div className="mx-auto p-6 bg-white rounded-lg text-gray-800 leading-relaxed text-lg">
                    ...
                    <div className="mb-6 text-lg">
                        <p>
                            <span className="border-b border-gray-400 pt-4 mr-2">
                                {landlord.fullName}{' '}
                            </span>{' '}
                        ...
                        <p className="mt-1">
                            Agissant en qualité de copropriétaire, ci-après
                            dénommé <strong>le « Bailleur »</strong>, d’une part
                            ;
                        </p>
                    </div>
                    ...
                    <div className="mb-6 text-lg">
                        <p>
                            <strong>NYLC S.A.</strong>, société anonyme
                            constituée en vertu des lois haïtiennes, ayant son
                            siège social au #11, rue Ogé, Pétion-Ville, Delmas,
                            Haiti. Représentée par Monsieur
                            ...
                            dénommée la <strong>« Preneuse »</strong>, d’autre
                            part.
                        </p>
                    </div>
                   ...
                   <p className="text-lg">
                    ...
                    <p className="text-lg">
                        ...
                        année(s), du
                        <span className="inline-block w-auto border-b border-gray-400 ml-2 mr-r">
                            <FrenchDate dateString={bank.date} />
                        </span>{' '}
                        au
                        <span className="inline-block w-auto border-b border-gray-400 ml-2 mr-r">
                            <FrenchDate
                                dateString={bank.date}
                                y={bank.yearCount}
                            />
                        </span>
                        .
                    ...
                    <p className="text-lg">
                        ...
                        <span className="inline-block w-auto border-b border-gray-400 ml-2">
                            ...
                            {new Intl.NumberFormat('fr-FR').format(
                                Number(bank?.final_rentCost || 0),
                            )}
                        </span>{' '}
                        (
                        <span className="inline-block w-auto uppercase border-b border-gray-400 mx-2">
                            {n2words(bank?.final_rentCost || 0, { lang: 'fr' })}
                        </span>
                    ...
                    {(!bank?.final_rentCost || bank?.final_rentCost == 0) && (
                        <p className="text-red-400 text-lg">
                            Le montant du loyer est égal à 0, vous devez aller
                            le modifier dans la section Banks Actives → Contrat
                        </p>
                    )}
                    ...
                    <div className="mt-6 text-lg">
                        <p>
                            ...
                            , de bonne foi, et en double original, le
                            <span className="inline-block w-48 border-b border-gray-400 mx-2" />
                            .
                        </p>
                    </div>
