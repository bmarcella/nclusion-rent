                ...
                <div className="space-y-2">
                    {bank.demoDetails && (
                        <div>
                            ...
                            <p>
                                ...
                                {renderTranslatedArray(
                                    bank.demoDetails.internetService,
                                    'bank.internetProviders',
                                )}
                            </p>
                            <p>
                                <strong>
                                    {t('bank.lotteryCompetitions.label')}:{' '}
                                </strong>
                                {renderTranslated(
                                    bank.demoDetails.lotteryCompetition,
                                    'bank.lotteryCompetitions',
                                )}
                            </p>
                            <p>
                                <strong>
                                    {t('bank.bankEntrances.label')}:{' '}
                                </strong>
                                {renderTranslatedArray(
                                    bank.demoDetails.bankEntrance,
                                    'bank.bankEntrances',
                                )}
                            </p>
                            <p>
                                <strong>
                                    {t('bank.populationInAreas.label')}:{' '}
                                </strong>
                                {renderTranslated(
                                    bank.demoDetails.populationInArea,
                                    'bank.populationInAreas',
                                )}
                            </p>
                            <p>
                                <strong>
                                    {t('bank.expectedRevenue.label')}:{' '}
                                </strong>
                                {renderTranslated(
                                    bank.demoDetails.expectedRevenue,
                                    'bank.expectedRevenue',
                                )}
                            </p>
                            <p>
                                <strong>
                                    {t('bank.buildingStabilities.label')}:{' '}
                                </strong>
                                {renderTranslated(
                                    bank.demoDetails.buildingStability,
                                    'bank.buildingStabilities',
                                )}
                            </p>
                        </div>
                    )}
                    ...
                    {bank.securityDetails && (
                        <div className="mt-4">
                            <h3 className="text-xl font-semibold mb-2 flex items-center gap-2">
                                <FaShieldAlt />{' '}
                                {t('bank.currentSecurities.label')}
                            </h3>
                            <p>
                                <strong>
                                    {t('bank.areaStabilities.label')}:{' '}
                                </strong>
                                {renderTranslated(
                                    bank.securityDetails.areaStability,
                                    'bank.areaStabilities',
                                )}
                            </p>
                            <p>
                                <strong>{t('bank.openHours.label')}: </strong>
                                {renderTranslated(
                                    bank.securityDetails.openHour,
                                    'bank.openHours',
                                )}
                            </p>
                            <p>
                                ...
                                {renderTranslated(
                                    bank.securityDetails.closeHour,
                                    'bank.closeHours',
                                )}
                            </p>
                            <p>
                                ...
                                {renderTranslatedArray(
                                    bank.securityDetails.currentSecurity,
                                    'bank.currentSecurities',
                                )}
                            </p>
                        </div>
                    )}
                    ...
                    {bank.renovationDetails && (
                        <div className="mt-4">
                            ...
                            <p>
                                ...
                                {renderTranslatedArray(
                                    bank.renovationDetails.neededSecurity,
                                    'bank.currentSecurities',
                                )}
                            </p>
                            <p>
                                <strong>
                                    {t('bank.majorRenovations.label')}:{' '}
                                </strong>
                                {renderTranslatedArray(
                                    bank.renovationDetails.majorRenovation,
                                    'bank.majorRenovations',
                                )}
                            </p>
                            <p>
                                <strong>
                                    {t('bank.minorRenovations.label')}:{' '}
                                </strong>
                                {renderTranslatedArray(
                                    bank.renovationDetails.minorRenovation,
                                    'bank.minorRenovations',
                                )}
                            </p>
                        </div>
                    )}
