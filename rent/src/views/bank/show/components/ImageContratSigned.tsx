...
export type ContractSignedImage = {
    id?: string
    bankId: string
    fileName: string
    imageUrl: string
...
const ContractSignedImageComp: React.FC<ImageGalleryProps> = ({
    images,
    canDownload = true,
    onDelete = (i: any) => {},
    userId,
...
export default ContractSignedImageComp
