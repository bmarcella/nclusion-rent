        ...
        <div className="w-full bg-gray-50 dark:bg-gray-700 rounded p-4 shadow">
            <Form onSubmit={handleSubmit(onSubmit)}>
                <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                    <FormItem
                        label={t('bank.internetProviders.label')}
                        invalid={!!errors.internetService}
                        errorMessage={errors.internetService?.message}
                    >
                        <Controller
                    ...
                    <FormItem
                        label={t('bank.previousUses.label')}
                        invalid={!!errors.previousUse}
                        errorMessage={errors.previousUse?.message}
                    >
                        <Controller
                            name="previousUse"
                            control={control}
                    ...
                    <FormItem
                        label={t('bank.nonRenewalReasons.label')}
                        invalid={!!errors.nonRenewalReason}
                        errorMessage={errors.nonRenewalReason?.message}
                    >
                        <Controller
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mt-4">
                    <FormItem
                        label={t('bank.lotteryCompetitions.label')}
                        invalid={!!errors.lotteryCompetition}
                        errorMessage={errors.lotteryCompetition?.message}
                    >
                        <Controller
                    ...
                    <FormItem
                        label={t('bank.clientVisibilities.label')}
                        invalid={!!errors.clientVisibility}
                        errorMessage={errors.clientVisibility?.message}
                    >
                        <Controller
                    ...
                    <FormItem
                        label={t('bank.bankEntrances.label')}
                        invalid={!!errors.bankEntrance}
                        errorMessage={errors.bankEntrance?.message}
                    >
                        <Controller
                            name="bankEntrance"
                            control={control}
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mt-4">
                    <FormItem
                        label={t('bank.populationInAreas.label')}
                        invalid={!!errors.populationInArea}
                        errorMessage={errors.populationInArea?.message}
                    >
                        <Controller
                    ...
                    <FormItem
                        label={t('bank.expectedRevenue.label')}
                        invalid={!!errors.expectedRevenue}
                        errorMessage={errors.expectedRevenue?.message}
                    >
                        <Controller
                    ...
                    <FormItem
                        label={t('bank.buildingStabilities.label')}
                        invalid={!!errors.buildingStability}
                        errorMessage={errors.buildingStability?.message}
                    >
                        <Controller
