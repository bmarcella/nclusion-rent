...
import {
    getOtherBankPicturesRef,
    otherBankPicturesDoc,
...
import ContractSignedImageComp, {
    ContractSignedImage,
} from '../../show/components/ImageContratSigned'
