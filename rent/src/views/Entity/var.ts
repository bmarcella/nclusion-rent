...
export const whoReferreds = [
    'Le proprietaire',
    'Joueurs de loterie dans la region',
    'Marchands',
    'entreprises',
    "Ancien agent qui ont vendu à l'emplacement",
    'Concurents',
    'Les gens assis autour',
] as const
...
export const clientVisibilities = [
    ...
    'Entrée simple',
    ' Murs pour peindre la publicité',
    'Espace sur le toit pour peindre le logo',
] as const
...
export const currentSecurities = [
    'Cadenas',
    'Toiture en beton',
    'Fenêtre métallique/barrée',
    'Porte métallique/barrée',
] as const
export const majorRenovations = [
    'Nouveau toit en tôle',
    'Nouveau toit en béton',
