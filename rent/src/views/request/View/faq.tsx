        ...
        () => [
            {
                ...
                content: (
                    <Section title="Objectif">
                        <p>
                            Garantir que toutes les activités
                            d’approvisionnement sont menées de manière
                            responsable, économique et via des processus ouverts
                            et concurrentiels.
                        </p>
                        <Section title="Équilibre recherché">
                            <p>
                                <strong>Agilité Opérationnelle</strong> —
                                permettre aux équipes d’agir rapidement.
                            </p>
                            <p>
                                <strong>Gouvernance & Contrôle</strong> —
                                assurer conformité, discipline financière et
                                éthique.
                            </p>
                        </Section>
                    </Section>
            ...
            },
            {
                ...
                content: (
                    <Section title="Responsabilités">
                        <p>
                            <strong>Assistant Coordonnateur :</strong> initie
                            les demandes avec justification et coûts.
                        </p>
                        <p>
                            <strong>Managers / Coordonnateurs :</strong>{' '}
                            examinent et approuvent selon délégation.
                        </p>
                        <p>
                            <strong>Finance :</strong> contrôle, initie
                            paiement, maintient séparation des tâches.
                        </p>
                        <p>
                            <strong>Direction / COO :</strong> approuve les
                            achats stratégiques ou de grande valeur.
                        </p>
                    </Section>
                ),
            },
            ...
            },
            {
                ...
                content: (
                    <Section title="Cycle">
                        <p>
                            Demande → Approbation Régionale → Approbation NYLC →
                            Approbation COO
                        </p>
                        <p>
                            Documents requis : Pro-forma, facture, pièce
            ...
            },
            {
                ...
                content: (
                    <Section title="Seuils">
                        <p>
                            Les seuils sont définis par la matrice de délégation
                            interne (HT uniquement).
                        </p>
                    </Section>
                ),
            },
            {
                ...
                content: (
                    <Section title="Gestion">
                        <p>
                            Sélection basée sur coût, qualité, fiabilité,
                            conformité et valeurs.
                        </p>
                        <p>
                            Revue annuelle des fournisseurs clés et divulgation
            ...
            },
            {
                ...
                content: (
                    <Section title="Rétention">
                        <p>
                            Documentation complète requise. Rétention minimale :
                            7 ans.
                        </p>
            ...
            },
            {
                ...
                content: (
                    <Section title="Rapports">
                        <p>
                            Rapports trimestriels préparés pour le CFO et la
                            Direction.
                        </p>
                    </Section>
                ),
            },
            {
                ...
                content: (
                    <Section title="Mise à jour">
                        <p>
                            Révision annuelle ou lors de changements majeurs
