...
function DetailsRequest({
    ...
    const formatDate = (value: any) => {
        if (!value) return '-'
        return formatRelative(value.toDate?.() || value, new Date(), {
            locale: fr,
        })
    }
            ...
            <Card className="p-4 space-y-2">
                ...
                <div className="grid grid-cols-3 md:grid-cols-3 gap-3 text-sm mt-4">
                    <div>
                        ...
                        <div>
                            {formatMoney(price)} {general.currency}
                        </div>
                    </div>
                    <div>
            ...
            <Card className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm mt-4 mb-4">
                    <div className="text-sm">
                        ...
                        <div>
                            {formatMoney(total_price)} {general.currency}
                        </div>
                    </div>
                    <div>
                        <div className="font-bold">Categorie</div>
            ...
            <Card className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                        <div className="font-bold">Amount</div>
                        <div>
                            {formatMoney(amount)} {general.currency}
                        </div>
                    </div>
            ...
            <Card className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-sm mt-4">
                    ...
                    <div>
                        <div className="font-bold">Amount</div>
                        <div>
                            {formatMoney(t.amount)} {general.currency}
                        </div>
                    </div>
                    <div>
                        <div className="font-bold">Categorie</div>
            ...
            <Card className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-3 md-grid-cols-2 gap-3 text-sm mt-4">
                    ...
                    <div>
                        ...
                        <div>
                            {formatMoney(b.total_amount)} {general.currency}
                        </div>
                    </div>
                    <div>
                        <div className="font-bold">Start date</div>
                    ...
                    <div onClick={() => navigate('/contrat/' + b.contract_id)}>
                        ...
                        <div className="underline text-blue-500 hover:text-blue-200">
                            {b.contract_id}
                        </div>
                    </div>
                </div>
            ...
            <Card className="p-4 space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm mt-3">
                    <div>
                        ...
                        <Tag
                            className={classNames(
                                getTypeRequestTagClasses(typeRequest),
                                'mb-1 mr-1',
                            )}
                        >
                            {t('request.' + typeRequest)}
                        </Tag>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div>
                            {getRegionsById(general.id_region_user).label}
                        </div>
                    </div>
                    <div>
