  ...
  return (<>
    ...
    <FormProvider  {...methods}>
      ...
      >
        ...
        {type === "transport_logistique" && <TransportFields t={t} region={region} categories={stype.categories} />}
        {type === "capex" && <CapexFields t={t} categories={stype.categories} />}
        {type === "bill" && <BillFields t={t} categories={stype.categories} />}
