...
import {
    ...
    Section,
    DiversFields,
} from '../../entities/RequestComponent'
        ...
        <>
            ...
            <FormProvider {...methods}>
                ...
                >
                    ...
                    {type === 'locomotif' && (
                        <LocomotifFields t={t} categories={stype.categories} />
                    )}
                    {type === 'telecom' && (
                        <TelecomFields t={t} categories={stype.categories} />
                    )}
                    {type === 'opex' && (
                        <OpexFields t={t} categories={stype.categories} />
                    )}
                    {type === 'transport_logistique' && (
                        <TransportFields
                            t={t}
                            region={region}
                            categories={stype.categories}
                        />
                    )}
                    {type === 'capex' && (
                        <CapexFields t={t} categories={stype.categories} />
                    )}
                    {type === 'bill' && (
                        <BillFields t={t} categories={stype.categories} />
                    )}

                    {type === 'bank_renovation' && (
                        <BankRenovationFields
                            t={t}
                            categories={stype.categories}
                        />
                    ...
                    {type === 'divers' && (
                        <DiversFields t={t} categories={stype.categories} />
                    )}
