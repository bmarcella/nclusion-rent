...
export const REQUEST_STATUS_VALUES_ACTION = ['approved', 'completed'] as const
...
export const getRequestCategorieById = (
    t: any,
    tReq: string,
    catId: number,
): string => {
...
export const getRequestCategorieTypeById = (
    t: any,
    tReq: string,
    catId: number,
): any => {
...
export const getCategorieName = (t: any, row: IRequest) => {
    ...
    switch (row.requestType) {
        ...
        case 'divers':
            return row?.divers?.categorie != null
                ? cat(row.divers.categorie)
                : ''
        ...
        case 'locomotif':
            return row?.locomotif?.categorie != null
                ? cat(row.locomotif.categorie)
                : ''

        case 'telecom':
            return row?.telecom?.categorie != null
                ? cat(row.telecom.categorie)
                : ''
...
export const requestType = (t: any, type: boolean = false) => [
    ...
    },
    {
        ...
        categories: [
            ...
            { value: 4, label: t('request.type.2.categories.4') },
            { value: 5, label: t('request.type.2.categories.5') },
            { value: 6, label: t('request.type.2.categories.6') },
    ...
    },
    {
        ...
        documentType: [],
        categories: [{ value: 1, label: t('request.type.8.categories.1') }],
    },
    {
        id: 9,
